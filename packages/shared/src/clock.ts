// Countdown formatting for the vehicle and stop panels, so both render arrival times
// identically. The 1 Hz `useNow` hook that drives it is React and lives in each app.
